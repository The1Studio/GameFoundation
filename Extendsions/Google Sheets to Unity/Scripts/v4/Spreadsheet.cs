...
namespace GoogleSheetsToUnity
{
    ...
    public class GSTU_Search
    {
        ...
        public readonly string startCell = "1";
        public readonly string endCell   = "10000";
    ...
    public class GSTU_Cell
    {
        ...
        public GSTU_Cell(string value) { this.value = value; }

        public string Column()  { return column; }
        public int    Row()     { return row; }
        public string CellRef() { return column + row; }
    ...
    public class GSTU_SpreadsheetResponce
    {
        ...
        public string WorkSheet() { return valueRange.range.Substring(0, valueRange.range.IndexOf("!") - 1); }
        ...
        public string EndCell() { return valueRange.range.Substring(valueRange.range.IndexOf(":") + 1); }

        public GSTU_SpreadsheetResponce() { }

        public GSTU_SpreadsheetResponce(ValueRange data) { valueRange = data; }
    }
    ...
    public class BatchRequestBody
    {
        ...
        public void Add(ValueRange data) { this.data.Add(data); }

        public void Send(string spreadsheetId, string worksheet, UnityAction callback) { SpreadsheetManager.WriteBatch(new GSTU_Search(spreadsheetId, worksheet), this, callback); }
    }
    ...
    public class GstuSpreadSheet
    {
        ...
        public GSTU_Cell this[string cellRef] { get { return Cells[cellRef]; } }
